<%-- 
    ...
    Created on : 25-Aug-2023, 1:30:26 am
                ...
                <div class="col-md-6 offset-md-3">
                    ...
                    <div class="card-body">
                        ...
                        <form id="reg_form" action="RegisterServlet"  method="POST">
                            ...
                            <div class="form-group">
                                <textarea name="about" class="form-control" id="" rows="3" placeholder="Enter something about your self"></textarea>
                            </div>
    ...
    $.ajax({
        ...
        success: function(data,textStatus,jqXHR){
            ...
            $("#submit-btn").show();
             ...
             swal(" Registered successfully. we are redirect to login page")
                    .then((value) => {
